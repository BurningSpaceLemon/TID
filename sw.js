...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    // Keep the current cache and one previous app cache as rollback safety.
...
self.addEventListener('fetch', event => {
  ...
  // HTML and version metadata: network first, then offline cache.
  ...
  // Static same-origin assets: cache first, background refresh.
  event.respondWith((async () => {
